                  ...
                  <div className="py-1">
                    {searchResults.map((result) => (
                      <button
                        key={result.id}
                        type="button"
                        className="w-full px-3 py-2 hover:bg-muted cursor-pointer transition-colors text-left focus:bg-muted focus:outline-none z-50"
                        onClick={(e) => {
                          e.preventDefault();
                          e.stopPropagation();
                      ...
                      >
                        <div className="flex items-center space-x-2 pointer-events-none z-50">
